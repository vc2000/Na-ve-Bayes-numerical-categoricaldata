    ...
    def __init__(self, filename, dataFormat):
        ...
        for (category, columns) in numericValues.items():
            ...
            for (col, values) in columns.items():
                ...
                columns[col] = 0
                # zero also mean False and anything else is True and 'or' will take the first True value
                self.ssd[category][col] = math.sqrt(SumOfSquareDifferences / ((classes[category]  - 1) or 1))
                # itemVector is attribute
